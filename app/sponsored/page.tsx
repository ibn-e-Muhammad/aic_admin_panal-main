...
import Sponsored from '@/components/features/sponsored';
        ...
        <header className="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">
          <Sheet>
            ...
            <SheetContent side="left" className="flex flex-col">
              ...
              <Link
                href="/sponsored"
                className="mx-[-0.65rem] flex  bg-muted items-center gap-4 rounded-xl px-3 py-2 text-muted-foreground hover:text-foreground"
              >
