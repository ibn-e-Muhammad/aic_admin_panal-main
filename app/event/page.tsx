...
import Orders from "@/components/features/allevents";
import AdminSearch from "@/components/features/admin-search";

import { Button } from "@/components/ui/button";
import AddEvent from "@/components/features/add-event";
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="flex flex-col">
              <nav className="grid gap-2 text-lg font-medium">
                ...
                <Link
                  href="/event"
                  className="mx-[-0.65rem] bg-muted   flex items-center gap-4 rounded-xl  px-3 py-2 text-foreground hover:text-foreground"
                >
